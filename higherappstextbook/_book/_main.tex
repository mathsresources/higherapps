...
\emph{Quadratic relationships} occur in a wide range of situations, from the shape of satelite dishes to the design of certain kinds of bridges. One of the most common applications of a quadratic equation is when considering any object acting under gravity, such as a ball thrown through the air.
...
The key feature of any parabola is that it either \emph{falls then rises} or \emph{rises then falls} \textbf{symmetrically}, with a \emph{turning point} in the middle - either a \emph{minimum turning point} or a \emph{maximum turning point} respectively. Studying \emph{quadratic behaviour} in detail forms parts of the National 5 Mathematics and Higher Mathematics courses. Key skills required for the Higher Applications course include:
