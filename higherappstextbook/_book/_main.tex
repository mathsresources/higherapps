...
The key feature of any parabola is that it either \emph{falls then rises} or \emph{rises then falls} symmetrically, with a \emph{turning point} in the middle - either a \emph{minimum turning point} or a \emph{maximum turning point} respectively. Studying \emph{quadratic behaviour} in detail form parts of the National 5 Mathematics and Higher Mathematics courses. Key skills required for the Higher Applications course include:
