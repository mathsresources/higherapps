...
Creating graph of a possible model is a good starting point in understanding any relationship. The \emph{independent} variable should be placed along the \(x\)-axis and the \emph{response} variable placed on the \(y\)-axis.
