...
You may have may have estimated a different proportion of pupils that use the dining hall, and a different average spend. It is expected your final answer will vary based on your estimates of the different \emph{variables}.
...
\section{Modelling Relationships}\label{modelling-relationships}
...
Initially a consideration of a possible relationship should be \emph{descriptive}, thinking about when the dependent variable might be increasing slowly, increasing more quickly, decreasing, at zero or other specific values. \emph{Graphs} can help:
