...
*Quadratic relationships* occur in a wide range of situations, from the shape of satelite dishes to the design of certain kinds of bridges. One of the most common applications of a quadratic equation is when considering any object acting under gravity, such as a ball thrown through the air.

\begin{multicols}{2}

\begin{center}
    \begin{tikzpicture}
        \draw[thin,samples=100,smooth,domain=0.5:6.7,dashed] plot (\x,{-0.2*(\x)^2+1.4*(\x)+0.85});
...
The key feature of any parabola is that it either *falls then rises* or *rises then falls* symmetrically, with a *turning point* in the middle - either a *minimum turning point* or a *maximum turning point* respectively. Studying *quadratic behaviour* in detail form parts of the National 5 Mathematics and Higher Mathematics courses. Key skills required for the Higher Applications course include:
